...
typedef enum 
{
    HVBUS_ADC,//Channel Name:AN2   Assigned to:Shared Channel
    TEMPERATURE1_ADC,//Channel Name:AN4   Assigned to:Shared Channel
    VAC1_ADC,//Channel Name:AN10   Assigned to:Shared Channel
    VAC2_ADC,//Channel Name:AN11   Assigned to:Shared Channel
    TEMPERATURE2_ADC,//Channel Name:AN13   Assigned to:Shared Channel
    channel_AN24,//Channel Name:AN24   Assigned to:Shared Channel
    channel_AN25,//Channel Name:AN25   Assigned to:Shared Channel
    I_PFC_ADC,//Channel Name:AN1   Assigned to:Dedicated Core1
} ADC1_CHANNEL;
...
/**
  @Summary
    ADC1 HVBUS_ADC callback routine.

  @Description
    This routine is a ADC1 HVBUS_ADC callback function.
  ...
  @Example 
    <code>
        ADC1_SetHVBUS_ADCInterruptHandler(&ADC1_HVBUS_ADC_CallBack);
    </code>
*/
void ADC1_HVBUS_ADC_CallBack(uint16_t adcVal);

/**
  @Summary
    Assigns a function pointer with a ADC1 HVBUS_ADC callback address.

  @Description
    This routine assigns a function pointer with a ADC1 HVBUS_ADC callback address.
...
*/
void ADC1_SetHVBUS_ADCInterruptHandler(void* handler);
...
/**
  ...
  @Description
    This routine is used to implement the tasks for ADC1 HVBUS_ADC polled implementations.
  ...
  @Example
    <code>    
        ADC1_HVBUS_ADC_Tasks();
    </code>
*/
void ADC1_HVBUS_ADC_Tasks(void);

/**
  @Summary
    ADC1 TEMPERATURE1_ADC callback routine.

  @Description
    This routine is a ADC1 TEMPERATURE1_ADC callback function.
  ...
  @Example 
    <code>
        ADC1_SetTEMPERATURE1_ADCInterruptHandler(&ADC1_TEMPERATURE1_ADC_CallBack);
    </code>
*/
void ADC1_TEMPERATURE1_ADC_CallBack(uint16_t adcVal);

/**
  @Summary
    Assigns a function pointer with a ADC1 TEMPERATURE1_ADC callback address.

  @Description
    This routine assigns a function pointer with a ADC1 TEMPERATURE1_ADC callback address.
...
*/
void ADC1_SetTEMPERATURE1_ADCInterruptHandler(void* handler);
...
/**
  ...
  @Description
    This routine is used to implement the tasks for ADC1 TEMPERATURE1_ADC polled implementations.
  ...
  @Example
    <code>    
        ADC1_TEMPERATURE1_ADC_Tasks();
    </code>
*/
void ADC1_TEMPERATURE1_ADC_Tasks(void);

/**
  @Summary
    ADC1 VAC1_ADC callback routine.

  @Description
    This routine is a ADC1 VAC1_ADC callback function.
  ...
  @Example 
    <code>
        ADC1_SetVAC1_ADCInterruptHandler(&ADC1_VAC1_ADC_CallBack);
    </code>
*/
void ADC1_VAC1_ADC_CallBack(uint16_t adcVal);

/**
  @Summary
    Assigns a function pointer with a ADC1 VAC1_ADC callback address.

  @Description
    This routine assigns a function pointer with a ADC1 VAC1_ADC callback address.
...
*/
void ADC1_SetVAC1_ADCInterruptHandler(void* handler);
...
/**
  ...
  @Description
    This routine is used to implement the tasks for ADC1 VAC1_ADC polled implementations.
...
*/
void ADC1_VAC1_ADC_Tasks(void);

/**
  @Summary
    ADC1 VAC2_ADC callback routine.

  @Description
    This routine is a ADC1 VAC2_ADC callback function.
  ...
  @Example 
    <code>
        ADC1_SetVAC2_ADCInterruptHandler(&ADC1_VAC2_ADC_CallBack);
    </code>
*/
void ADC1_VAC2_ADC_CallBack(uint16_t adcVal);

/**
  @Summary
    Assigns a function pointer with a ADC1 VAC2_ADC callback address.

  @Description
    This routine assigns a function pointer with a ADC1 VAC2_ADC callback address.
...
*/
void ADC1_SetVAC2_ADCInterruptHandler(void* handler);
...
/**
  ...
  @Description
    This routine is used to implement the tasks for ADC1 VAC2_ADC polled implementations.
...
*/
void ADC1_VAC2_ADC_Tasks(void);

/**
  @Summary
    ADC1 TEMPERATURE2_ADC callback routine.

  @Description
    This routine is a ADC1 TEMPERATURE2_ADC callback function.
  ...
  @Example 
    <code>
        ADC1_SetTEMPERATURE2_ADCInterruptHandler(&ADC1_TEMPERATURE2_ADC_CallBack);
    </code>
*/
void ADC1_TEMPERATURE2_ADC_CallBack(uint16_t adcVal);

/**
  @Summary
    Assigns a function pointer with a ADC1 TEMPERATURE2_ADC callback address.

  @Description
    This routine assigns a function pointer with a ADC1 TEMPERATURE2_ADC callback address.
...
*/
void ADC1_SetTEMPERATURE2_ADCInterruptHandler(void* handler);
...
/**
  @Summary
    ADC1 I_PFC_ADC callback routine.

  @Description
    This routine is a ADC1 I_PFC_ADC callback function.
  ...
  @Example 
    <code>
        ADC1_SetI_PFC_ADCInterruptHandler(&ADC1_I_PFC_ADC_CallBack);
    </code>
*/
void ADC1_I_PFC_ADC_CallBack(uint16_t adcVal);

/**
  @Summary
    Assigns a function pointer with a ADC1 I_PFC_ADC callback address.

  @Description
    This routine assigns a function pointer with a ADC1 I_PFC_ADC callback address.
...
*/
void ADC1_SetI_PFC_ADCInterruptHandler(void* handler);
...
/**
  ...
  @Description
    This routine is used to implement the tasks for ADC1 I_PFC_ADC polled implementations.
  ...
  @Example
    <code>    
        ADC1_I_PFC_ADC_Tasks();
    </code>
*/
void ADC1_I_PFC_ADC_Tasks(void);
